...
final class StarRatingInteractorTests: XCTestCase {
	func test_doFetchStarRating_presentsInitialState() {
	...
	func test_handleStarRatingReset_presentsResetState() {
		let (sut, presenter) = makeSUT(selectedStarRatings: [.three])

		sut.handleStarRatingReset(request: .init())
	...
	func test_handleStarRatingSelection_presentsSelectedStarRatings() {
		let (sut, presenter) = makeSUT(selectedStarRatings: [])

		sut.handleStarRatingSelection(request: .init(starRating: .five))
	...
	func test_handleStarRatingSelectionWithAlreadySelectedStarRatings_presentsDeselectedStarRatings() {
...
final class StarRatingPresentationLogicSpy: StarRatingPresentationLogic {
	enum Messages: Equatable {
		case present(StarRatingModels.FetchStarRating.Response)
		case presentReset(StarRatingModels.StarRatingReset.Response)
		case presentSelect(StarRatingModels.StarRatingSelection.Response)
	}
